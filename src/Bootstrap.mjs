...
export default class Bootstrap {
   ...
   */
  constructor({module, path, logger, cliConfig, runtimeFactory, authService, pipelineEngine, authenticationHandler, principalApiAuthHandler, principalContributionHandler, reservedRoutesHandler, staticHandler, sourceFactory}) {
